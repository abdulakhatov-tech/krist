...
const CategoryAccordionItem: React.FC<{ category: ICategoryItem }> = ({
	...
	return (
		<AccordionItem value={category.id} className="border-b-0">
			{hasChildren ? (
				<>
					<AccordionTrigger className="hover:no-underline py-2 px-4 hover:bg-[#222] hover:text-white hover:scale-[0.94] rounded data-[state=open]:bg-[#222] data-[state=open]:text-white">
